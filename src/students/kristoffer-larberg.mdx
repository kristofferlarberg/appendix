...
<ImageZoom 
  preview={preview}
  zoom={zoom}
  alt="Baking the kitchen – Exhibition, Photo: Sanna Lindberg"
  caption="Baking the kitchen – Exhibition <br/> Photo: Sanna Lindberg"
/>

![gif](../images/test.gif)

<iframe src="https://player.vimeo.com/video/417086807?title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>